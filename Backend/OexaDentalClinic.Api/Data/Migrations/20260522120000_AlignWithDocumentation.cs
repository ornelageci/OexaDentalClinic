...
{
    public partial class AlignWithDocumentation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_TreatmentRecords", x => x.Id))
                .Annotation("MySQL:Charset", "utf8mb4");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropTable(name: "TreatmentRecords");
            ...
            migrationBuilder.DropColumn(name: "IsSpecialAppointment", table: "Appointments");
            migrationBuilder.DropColumn(name: "PatientUserId", table: "Appointments");
            migrationBuilder.DropColumn(name: "AssignedDentistUserId", table: "Appointments");
        }
    }
}
